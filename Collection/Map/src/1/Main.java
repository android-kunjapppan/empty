...
public class Main
{
    ...
    public static  HashMap saveCountryCapital(String countryName,String capital)
    {
    ...
    public static HashMap converttoMap(HashMap M1)
    {
        Set s=M1.entrySet();
        Iterator itr=s.iterator();
        while(itr.hasNext())
    ...
    static ArrayList al=new ArrayList();
     public static ArrayList converttoAl(HashMap M1)
    {
        Set s= M1.entrySet();
        Iterator itr=s.iterator();
        while(itr.hasNext())
